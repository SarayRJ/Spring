package es.studium.beanAnidados;
...
public class Principal {
	...
	public static void main(String[] args) {
		/*Abrimos el contenedor de IoC indicando la ruta exacta del 
		fichero beans.xml (Inyección de dependencia vía setter o property)*/
